...
import {
    BookOpen, ArrowLeft, Calendar, User, Hash, FileText,
} from 'lucide-react';
            ...
            <div className="mx-auto max-w-4xl space-y-6 p-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a href={`/libros/${libro.id}/edit`}>
                        <Button className="bg-indigo-600 hover:bg-indigo-700">Editar libro</Button>
                    </a>
                </div>
                ...
                <Card className="overflow-hidden shadow-sm">
                    ...
                    <CardHeader>
                        <div className="flex items-start gap-4">
                            <div className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-xl ${color.bg}`}>
                                <BookOpen className={`h-8 w-8 ${color.text}`} />
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-neutral-600">
                                    {libro.autor || <span className="italic text-neutral-400">No especificado</span>}
                                </p>
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-neutral-600">
                                    {libro.anio_lanzamiento || <span className="italic text-neutral-400">No especificado</span>}
                                </p>
                            </div>
